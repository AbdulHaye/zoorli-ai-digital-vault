...
import { Loader2, Mail, User, Lock, CheckCircle, Eye, EyeOff } from 'lucide-react'
...
export default function SignUpForm({ onSuccess, onSwitchToSignIn }: SignUpFormProps) {
  ...
  }, [emailSent, countdown, onSwitchToSignIn])
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          Join Zorli AI Vault to start managing your files with AI-powered insights
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
